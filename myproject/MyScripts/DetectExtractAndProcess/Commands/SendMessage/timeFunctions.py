...
def convert_to_datetime_time(timeInfoString):
    '''
    ...
    try:
        ...
        match ampm_string[0]:
            ...
            case 'p':
                return datetime.time(hour= 12 + int(timeInfoString[0]),minute= int(timeInfoString[1]))
        return None
...
# print(convert_to_datetime_time("4.18pm"))